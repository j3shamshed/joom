    ...
    <div class="wpbucket-theme-page">
        ...
        <div class="page-content">
            ...
            <div class="theme-info">                
                <h2><?php echo esc_html($current_theme->get('Name')) ?></h2>
                <label><?php esc_html_e('Description:', 'yowel') ?></label>
                <p><?php echo esc_html($current_theme->get('Description')) ?></p>
                <label><?php esc_html_e('Tags:', 'yowel') ?></label>
                <p><?php echo join(", ", $current_theme->get('Tags')) ?></p>
                <label><?php esc_html_e('Version:', 'yowel') ?></label>
                <p><?php echo esc_html($current_theme->get('Version')) ?></p>
            </div>

            <!-- Documentation section -->
            <div class="theme-documentation">
                <h2><?php esc_html_e('Documentation', 'yowel') ?></h2>
                <p><?php esc_html_e('Theme comes with Documentation where you can find how to Setup and use the theme. Documentation can be found in archive downloaded from ThemeForest.', 'yowel') ?></p>            
            </div>

            <!-- Support section -->
            <div class="theme-support">
                <h2><?php esc_html_e('Support', 'yowel') ?></h2>
                <p><?php echo wp_kses(__("If you can't find answer to your problem in Documentation please register on our <a href='#' target='_BLANK'>support forum</a>.
                    We have dedicated team that will help you with your problem.", 'yowel'), $wpbucket_theme_config['allowed_html_tags']) ?><br/>
                    <?php echo wp_kses(__("Note that before registering you will need to obtain Purchase code from ThemeForest. Read <a href='#' target='_BLANK'>here</a> how to obtain key.", 'yowel'), $wpbucket_theme_config['allowed_html_tags']) ?>

                </p>
            </div>

           <!-- <div class="theme-updates">
                <h2><?php /*esc_html_e('Updates:', 'yowel') */?></h2>
                <p><?php /*esc_html_e('To receive notification for theme updates please install official ThemeForest plugin for updates:', 'yowel') */?> <a href="<?php /*echo esc_url(admin_url('admin.php?page=install-required-plugins')); */?>#updates"><?php /*esc_html_e('Envato Market - Updates.', 'yowel') */?></a></p>
            </div>-->
        </div>
