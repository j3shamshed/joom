        ...
        <section class="page-content">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <?php
                        echo wp_kses( __( 'Please activate <strong>Custom post types</strong> and <strong>MetaBox</strong> plugins.', 'yowel' ), $wpbucket_theme_config['allowed_html_tags'] );
                        ?>
                    </div>
                </div><!-- .row end -->
            </div><!-- .container end -->
