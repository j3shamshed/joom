...
if ( ! function_exists( 'wpbucket_wp_image_editor_check_notice' ) ) {
	function wpbucket_wp_image_editor_check_notice() {
	    printf( "<div class='error'><p>%s</div>",
	        esc_html__( "The server does not have ImageMagick or GD installed and/or enabled! Any of these libraries are required for WordPress to be able to resize images. Please contact your server administrator to enable this before continuing.", 'yowel' ) );
	}
}
...
if ( ! class_exists( 'Wpbucket_Image_Editor_GD_1_3' ) ) {
	...
	class Wpbucket_Image_Editor_GD_1_3 extends WP_Image_Editor_GD {
	    ...
	    public function rotate( $angle ) {
	        ...
	        return new WP_Error( 'image_rotate_error', esc_html__( 'Image rotate failed.', 'yowel' ), $this->file );
	    }
	    ...
	    public function opacity( $opacity ) {
	        ...
	        return new WP_Error( 'image_opacity_error', esc_html__('Image opacity change failed.', 'yowel' ), $this->file );
	    }
	    ...
	    public function colorize( $hexColor ) {
	        ...
	        return new WP_Error( 'image_colorize_error', esc_html__( 'Image color change failed.', 'yowel' ), $this->file );
	    }
	    ...
	    public function grayscale() {
	        ...
	        return new WP_Error( 'image_grayscale_error', esc_html__( 'Image grayscale failed.', 'yowel' ), $this->file );
	    }
	    ...
	    public function negate() {
	        ...
	        return new WP_Error( 'image_negate_error', esc_html__( 'Image negate failed.', 'yowel' ), $this->file );
	    }
	}
}
...
if ( ! class_exists( 'Wpbucket_Thumb_1_3' ) ) {
	...
	class Wpbucket_Thumb_1_3 {
	    ...
	    public static function thumb( $url, $params = array(), $single = true ) {
	        ...
	        $dst_rel_path = str_replace( '.' . $ext, '', wp_basename( $img_path ) );
