...
if( !class_exists( 'ReduxFramework_extension_js_button' ) ) {
    ...
    class ReduxFramework_extension_js_button {
        ...
        public $field_id = '';
        private $class_css = '';
        private $directory_of_this_file = '';
        ...
        */
        public function __construct( $parent ) {
            ...
            // Set parent object
            $this->parent = $parent;
            $this->directory_of_this_file = WPBUCKET_THEME_DIR.'/core/theme-options/custom-fields/js_button/';
            // Set extension dir
            if ( empty( $this->extension_dir ) ) {
                $this->extension_dir = trailingslashit( str_replace( '\\', '/', $this->directory_of_this_file ) );
        ...
        public function overload_field_path($field) {
            return $this->directory_of_this_file.'/'.$this->field_name.'/field_'.$this->field_name.'.php';
        }
    }
}